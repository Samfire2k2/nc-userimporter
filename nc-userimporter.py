...
config_protocol = "http" # use a secure connection!
  ...
  for row in readCSV:
    ...
    if response_xmlsoup.find('statuscode').string == "100":
      ...
      if config_EduDocs == 'yes':
        ...
        ptext = '<font size=14>Bonjour %s,</font>' % ncusername
      ...
      if config_EduDocs == 'yes':
        ...
        ptext = '<font size=14>un compte Nextcloud a été créé pour vous..</font>'
      Story.append(Paragraph(ptext, styles["Justify"]))
      Story.append(Spacer(1, 12))    
      ...
      if config_EduDocs == 'yes':
        ...
        ptext = '<font size=14>Vous pouvez vous connecter avec les informations suivantes :</font>'
      ...
      if config_EduDocs == 'yes':
        ...
        ptext = '<font size=14>Le lien de votre Nextcloud:</font>'
      Story.append(Paragraph(ptext, styles["Normal"]))
      Story.append(Spacer(1, 12))    
      ...
      if config_EduDocs == 'yes':
        ...
        ptext = '<font size=14>Identifiant :</font>'
      Story.append(Paragraph(ptext, styles["Normal"]))
      Story.append(Spacer(1, 12))    
      ...
      if config_EduDocs == 'yes':
        ...
        ptext = '<font size=14>Mot de passe :</font>'
      Story.append(Paragraph(ptext, styles["Normal"]))
      Story.append(Spacer(1, 12))    
      ...
      if config_EduDocs == 'yes':
        ...
        ptext = '<font size=14>Vous pouvez également scanner le QR code en bas du mail depuis votre application Nextcloud :</font>'
      Story.append(Paragraph(ptext, styles["Normal"]))
      Story.append(Spacer(1, 24))       
